...
curl_setopt_array($curl, array(
	CURLOPT_URL => "https://tealslab.com/api/leads/$token",
...
$curl = curl_init();
curl_setopt_array($curl, array(
	CURLOPT_URL => "https://tealslab.com/api/accountkey",
	CURLOPT_RETURNTRANSFER => true,
	CURLOPT_ENCODING => "",
	CURLOPT_MAXREDIRS => 10,
	CURLOPT_TIMEOUT => 30,
...
<head>
  <title>Design Layer Agency Secure Payment</title>
   ...
   <div class="main_nav">
        <div class="container">   
            <nav class="navbar navbar-expand-lg navbar-light">
                <a class="navbar-brand logo" href="/" data-aos="fade-down" data-aos-duration="1000"> <img class="img-fluid" src="assets/images/logo.svg" alt="logoa" style="width:50%;"> </a>
				...
				<div class="cardInfo">
					<div class="card myCardPay" >
						<div class="card-header text-center text-black">
							<h2 class="card-heading" style="color:black;">Invoice from Design Layer Agency</h2>
